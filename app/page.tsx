    ...
    <>
      ...
      <section className="relative overflow-hidden bg-white text-black">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <Parallax
            speed={0.12}
            className="absolute -left-20 top-10 select-none"
          >
            <span
              aria-hidden
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-24 sm:px-8 sm:py-32">
          ...
          <div className="mt-16 grid border border-black/10 sm:grid-cols-2">
            <Reveal
              variant="scale"
              className="bg-white/50 p-8 backdrop-blur-lg backdrop-saturate-150 transition-all duration-300 hover:bg-white/80 sm:p-10"
            >
            ...
            <Reveal
              variant="scale"
              delay={120}
              className="border-t border-black/10 bg-white/50 p-8 backdrop-blur-lg backdrop-saturate-150 transition-all duration-300 hover:bg-white/80 sm:border-l sm:border-t-0 sm:p-10"
            >
